 ...
 */
public class UserGroupPickerField extends BaseField
{
    ...
    // CONSTRUCTOR
    // ///////////////////////////////////////////////////////////////////////////
    public UserGroupPickerField(Context context, FormManager manager, FormFieldRepresentation data, boolean isReadMode)
    {
    ...
    public String getHumanReadableReadValue()
    {
        ...
        {
            originalValue = LightGroupRepresentation.parse(originalValue);
        }
        if (originalValue instanceof LightGroupRepresentation)
        {
            readValue = ((LightGroupRepresentation) originalValue).getName();
        }
    ...
    public String getHumanReadableEditionValue()
    {
        ...
        {
            editionValue = LightGroupRepresentation.parse(editionValue);
        }
        if (editionValue instanceof LightGroupRepresentation)
        {
            readValue = ((LightGroupRepresentation) editionValue).getName();
        }
        else
        {
        ...
        if (getFragment() != null && editionView != null && !data.isReadOnly())
        {
            ...
            editionView.findViewById(R.id.button_container).setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    ...
                    UserGroupPickerFragment.with(getFragment().getActivity()).fragmentTag(getFragment().getTag())
