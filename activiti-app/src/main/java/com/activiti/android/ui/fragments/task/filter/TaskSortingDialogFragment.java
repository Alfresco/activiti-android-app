...
public class TaskSortingDialogFragment extends DialogFragment
{
    ...
    // ///////////////////////////////////////////////////////////////////////////
    public TaskSortingDialogFragment()
    {
        super();
    }

    public static TaskSortingDialogFragment newInstanceByTemplate(Bundle b)
    {
        TaskSortingDialogFragment cbf = new TaskSortingDialogFragment();
        cbf.setArguments(b);
        return cbf;
    }
    ...
    {
        String value = context.getString(R.string.task_filter_created_desc);
        try
        {
            switch (TaskSorting.fromValue(sortValue))
            {
                case CREATED_DESC:
                    value = context.getString(R.string.task_filter_created_desc);
                    break;
                case CREATED_ASC:
                    value = context.getString(R.string.task_filter_created_asc);
                    break;
                case DUE_DESC:
                    value = context.getString(R.string.task_filter_due_desc);
                    break;
                case DUE_ASC:
                    value = context.getString(R.string.task_filter_due_asc);
                    break;
            }
        }
    ...
    public static String getSortValue(int which)
    {
        ...
        switch (which)
        {
            ...
            case 1:
                ...
                break;
            case 2:
                value = RequestConstant.SORT_DUE_DESC;
                break;
            case 3:
                value = RequestConstant.SORT_DUE_ASC;
                break;
        }
        return value;
    }
