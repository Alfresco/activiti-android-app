...
public final class MimeTypeSchema
{
    ...
    private static final String QUERY_TABLE_CREATE = "CREATE TABLE " + TABLENAME + " (" + COLUMN_ID
            + " INTEGER PRIMARY KEY AUTOINCREMENT," + COLUMN_EXTENSION + " TEXT ," + COLUMN_TYPE + " TEXT NOT NULL,"
            + COLUMN_SUBTYPE + " TEXT NOT NULL," + COLUMN_DESCRIPTION + " TEXT NOT NULL," + COLUMN_SMALL_ICON
            + " TEXT," + COLUMN_LARGE_ICON + " TEXT" + ");";
    ...
    private static void create(SQLiteDatabase db)
    {
        ...
        insert(db, "aep", MimeType.TYPE_APPLICATION, "vnd.adobe.aftereffects.project", "Adobe AfterEffects Project",
                ICON_VIDEO, ICON_VIDEO_LARGE);
        insert(db, "aet", MimeType.TYPE_APPLICATION, "vnd.adobe.aftereffects.template", "Adobe AfterEffects Template",
                ICON_GENERIC, ICON_GENERIC_LARGE);
        insert(db, "ai", MimeType.TYPE_APPLICATION, "illustrator", "Adobe Illustrator File", "R.drawable.mime_ai",
                "R.drawable.mime_256_ai");
        ...
        insert(db, "air", MimeType.TYPE_APPLICATION, "vnd.adobe.air-application-installer-package+zip", "Adobe AIR",
                ICON_ZIP, ICON_ZIP_LARGE);
        insert(db, "apk", MimeType.TYPE_APPLICATION, "vnd.android.package-archive", "Android Package",
                "R.drawable.mime_apk", "R.drawable.mime_256_apk");
        ...
        insert(db, "asnd", MimeType.TYPE_AUDIO, "vnd.adobe.soundbooth", "Adobe Soundbooth", "R.drawable.mime_asnd",
                "R.drawable.mime_256_asnd");
        ...
        insert(db, "azw", MimeType.TYPE_APPLICATION, "vnd.amazon.ebook", "Amazon Kindle eBook format", ICON_TXT,
                ICON_TXT_LARGE);
        ...
        insert(db, "bin", MimeType.TYPE_APPLICATION, "octet-stream", "Binary File (Octet Stream)", ICON_GENERIC,
                ICON_GENERIC_LARGE);
        ...
        insert(db, "cab", MimeType.TYPE_APPLICATION, "vnd.ms-cab-compressed", "Microsoft Cabinet File", ICON_ZIP,
                ICON_ZIP_LARGE);
        insert(db, "cat", MimeType.TYPE_APPLICATION, "vnd.ms-pkiseccat", "Microsoft Security Catalog", ICON_ZIP,
                ICON_ZIP_LARGE);
        insert(db, "cer", MimeType.TYPE_APPLICATION, "x-x509-ca-cert",
                "Internet Public Key Infrastructure - Certificate", ICON_GENERIC, ICON_GENERIC_LARGE);
        ...
        insert(db, "clp", MimeType.TYPE_APPLICATION, "x-msclip", "Microsoft Clipboard Clip", ICON_GENERIC,
                ICON_GENERIC_LARGE);
        ...
        insert(db, "doc", MimeType.TYPE_APPLICATION, "msword", "Microsoft Word", "R.drawable.mime_doc",
                "R.drawable.mime_256_doc");
        insert(db, "doct", MimeType.TYPE_APPLICATION, "vnd.openxmlformats-officedocument.wordprocessingml.template",
                "Microsoft Word 2007 Template", "R.drawable.mime_doc", "R.drawable.mime_256_doc");
        insert(db, "docm", MimeType.TYPE_APPLICATION, "vnd.ms-word.document.macroenabled.12",
                "Microsoft Word 2007 macro-enabled document", "R.drawable.mime_doc", "R.drawable.mime_256_doc");
        insert(db, "docx", MimeType.TYPE_APPLICATION, "vnd.openxmlformats-officedocument.wordprocessingml.document",
                "Microsoft Word 2007", "R.drawable.mime_doc", "R.drawable.mime_256_doc");
        insert(db, "dot", MimeType.TYPE_APPLICATION, "msword", "Microsoft Word", "R.drawable.mime_doc",
                "R.drawable.mime_256_doc");
        insert(db, "dotm", MimeType.TYPE_APPLICATION, "vnd.ms-word.template.macroenabled.12",
                "Microsoft Word 2007 macro-enabled document template", "R.drawable.mime_doc", "R.drawable.mime_256_doc");
        insert(db, "dotx", MimeType.TYPE_APPLICATION, "vnd.openxmlformats-officedocument.wordprocessingml.template",
                "Microsoft Word 2007 template", "R.drawable.mime_doc", "R.drawable.mime_256_doc");
        ...
        insert(db, "dvi", MimeType.TYPE_APPLICATION, "x-dvi", "Device Independent File Format", ICON_GENERIC,
                ICON_GENERIC_LARGE);
        ...
        insert(db, "exe", MimeType.TYPE_APPLICATION, "octet-stream", "Binary File (Octet Stream)", ICON_GENERIC,
                ICON_GENERIC_LARGE);
        insert(db, "f4v", MimeType.TYPE_VIDEO, "x-f4v", "Flash Video", ICON_VIDEO, ICON_VIDEO_LARGE);
        insert(db, "fla", MimeType.TYPE_APPLICATION, "x-fla", "Flash Source", "R.drawable.mime_fla",
                "R.drawable.mime_256_fla");
        ...
        insert(db, "fm", MimeType.TYPE_APPLICATION, "vnd.framemaker", "Adobe FrameMaker", ICON_GENERIC,
                ICON_GENERIC_LARGE);
        insert(db, "ftl", MimeType.TYPE_TEXT, "plain", "Plain Text", ICON_TXT, ICON_TXT_LARGE);
        insert(db, "fxp", MimeType.TYPE_APPLICATION, "x-zip", "Adobe Flex Project File", "R.drawable.mime_fxp",
                "R.drawable.mime_256_fxp");
        insert(db, "gif", MimeType.TYPE_IMAGE, "gif", "GIF Image", ICON_IMG, ICON_IMG_LARGE);
        insert(db, "gml", MimeType.TYPE_APPLICATION, "sgml", "SGML (Machine Readable)", ICON_GENERIC,
                ICON_GENERIC_LARGE);
        ...
        insert(db, "h264", MimeType.TYPE_VIDEO, "h264", "H.264", ICON_VIDEO, ICON_VIDEO_LARGE);
        insert(db, "hdf", MimeType.TYPE_APPLICATION, "x-hdf", "Hierarchical Data Format", ICON_GENERIC,
                ICON_GENERIC_LARGE);
        insert(db, "hlp", MimeType.TYPE_APPLICATION, "winhlp", "WinHelp", ICON_GENERIC, ICON_GENERIC_LARGE);
        insert(db, "hqx", MimeType.TYPE_APPLICATION, "mac-binhex40", "Macintosh BinHex 4.0", ICON_GENERIC,
                ICON_GENERIC_LARGE);
        ...
        insert(db, "ind", MimeType.TYPE_APPLICATION, "x-indesign", "Adobe InDesign Document", "R.drawable.mime_indd",
                "R.drawable.mime_256_indd");
        insert(db, "indd", MimeType.TYPE_APPLICATION, "x-indesign", "Adobe InDesign Document", "R.drawable.mime_indd",
                "R.drawable.mime_256_indd");
        ...
        insert(db, "key", MimeType.TYPE_APPLICATION, "vnd.apple.keynote", "Apple iWork Keynote",
                "R.drawable.mime_keynote", "R.drawable.mime_256_keynote");
        insert(db, "kml", MimeType.TYPE_APPLICATION, "vnd.google-earth.kml+xml", "Google Earth KML", ICON_XML,
                ICON_XML_LARGE);
        insert(db, "kmz", MimeType.TYPE_APPLICATION, "vnd.google-earth.kmz", "Google Earth Zipped KML", ICON_ZIP,
                ICON_ZIP_LARGE);
        ...
        insert(db, "mid", MimeType.TYPE_AUDIO, "mid", "Musical Instrument Digital Interface", ICON_AUDIO,
                ICON_AUDIO_LARGE);
        ...
        insert(db, "mpp", MimeType.TYPE_APPLICATION, "vnd.ms-project", "Microsoft Project", ICON_GENERIC,
                ICON_GENERIC_LARGE);
        ...
        insert(db, "msg", MimeType.TYPE_APPLICATION, "vnd.ms-outlook", "Microsoft Outlook Message", ICON_GENERIC,
                ICON_GENERIC_LARGE);
        insert(db, "mv", MimeType.TYPE_VIDEO, "x-sgi-movie", "SGI Video", ICON_VIDEO, ICON_VIDEO_LARGE);
        insert(db, "mvb", MimeType.TYPE_APPLICATION, "x-msmediaview", "Microsoft MediaView", ICON_GENERIC,
                ICON_GENERIC_LARGE);
        insert(db, "mw", MimeType.TYPE_TEXT, "mediawiki", "MediaWiki Markup", ICON_TXT, ICON_TXT_LARGE);
        insert(db, "numbers", MimeType.TYPE_APPLICATION, "vnd.apple.numbers", "Apple iWork Numbers",
                "R.drawable.mime_numbers", "R.drawable.mime_256_numbers");
        ...
        insert(db, "oda", MimeType.TYPE_APPLICATION, "oda", "Office Document Architecture", ICON_GENERIC,
                ICON_GENERIC_LARGE);
        insert(db, "odb", MimeType.TYPE_APPLICATION, "vnd.oasis.opendocument.database", "OpenDocument Database",
                ICON_GENERIC, ICON_GENERIC_LARGE);
        insert(db, "odc", MimeType.TYPE_APPLICATION, "vnd.oasis.opendocument.chart", "OpenDocument Chart",
                ICON_GENERIC, ICON_GENERIC_LARGE);
        insert(db, "odf", MimeType.TYPE_APPLICATION, "vnd.oasis.opendocument.formula", "OpenDocument Formula",
                ICON_GENERIC, ICON_GENERIC_LARGE);
        insert(db, "odft", MimeType.TYPE_APPLICATION, "vnd.oasis.opendocument.formula-template",
                "OpenDocument Formula Template", ICON_GENERIC, ICON_GENERIC_LARGE);
        insert(db, "odg", MimeType.TYPE_APPLICATION, "vnd.oasis.opendocument.graphics", "OpenDocument Drawing",
                "R.drawable.mime_odg", "R.drawable.mime_256_odg");
        insert(db, "odi", MimeType.TYPE_APPLICATION, "vnd.oasis.opendocument.image", "OpenDocument Image", ICON_IMG,
                ICON_IMG_LARGE);
        insert(db, "odm", MimeType.TYPE_APPLICATION, "vnd.oasis.opendocument.text-master",
                "OpenDocument Master Document", ICON_GENERIC, ICON_GENERIC_LARGE);
        insert(db, "odp", MimeType.TYPE_APPLICATION, "vnd.oasis.opendocument.presentation",
                "OpenDocument Presentation", "R.drawable.mime_odp", "R.drawable.mime_256_odp");
        insert(db, "ods", MimeType.TYPE_APPLICATION, "vnd.oasis.opendocument.spreadsheet", "OpenDocument Spreadsheet",
                "R.drawable.mime_ods", "R.drawable.mime_256_ods");
        insert(db, "odt", MimeType.TYPE_APPLICATION, "vnd.oasis.opendocument.text", "OpenDocument Text",
                "R.drawable.mime_odt", "R.drawable.mime_256_odt");
        ...
        insert(db, "onetoc", MimeType.TYPE_APPLICATION, "onenote", "Microsoft OneNote", ICON_GENERIC,
                ICON_GENERIC_LARGE);
        insert(db, "onetoc2", MimeType.TYPE_APPLICATION, "onenote", "Microsoft OneNote", ICON_GENERIC,
                ICON_GENERIC_LARGE);
        insert(db, "onetmp", MimeType.TYPE_APPLICATION, "onenote", "Microsoft OneNote", ICON_GENERIC,
                ICON_GENERIC_LARGE);
        insert(db, "onepkg", MimeType.TYPE_APPLICATION, "onenote", "Microsoft OneNote", ICON_GENERIC,
                ICON_GENERIC_LARGE);
        insert(db, "orf", MimeType.TYPE_IMAGE, "x-raw-olympus", "Olympus  RAW Image", ICON_IMG, ICON_IMG_LARGE);
        insert(db, "otc", MimeType.TYPE_APPLICATION, "vnd.oasis.opendocument.chart-template",
                "OpenDocument Chart Template", ICON_GENERIC, ICON_GENERIC_LARGE);
        insert(db, "otg", MimeType.TYPE_APPLICATION, "vnd.oasis.opendocument.graphics-template",
                "OpenDocument Drawing Template", "R.drawable.mime_odg", "R.drawable.mime_256_odg");
        insert(db, "oth", MimeType.TYPE_APPLICATION, "vnd.oasis.opendocument.text-web", "OpenDocument HTML",
                ICON_GENERIC, ICON_GENERIC_LARGE);
        insert(db, "oti", MimeType.TYPE_APPLICATION, "vnd.oasis.opendocument.image-template",
                "OpenDocument Image Template", ICON_IMG, ICON_IMG_LARGE);
        insert(db, "otp", MimeType.TYPE_APPLICATION, "vnd.oasis.opendocument.presentation-template",
                "OpenDocument Presentation Template", "R.drawable.mime_odp", "R.drawable.mime_256_odp");
        insert(db, "ots", MimeType.TYPE_APPLICATION, "vnd.oasis.opendocument.spreadsheet-template",
                "OpenDocument Spreadsheet Template", "R.drawable.mime_ods", "R.drawable.mime_256_ods");
        insert(db, "ott", MimeType.TYPE_APPLICATION, "vnd.oasis.opendocument.text-template",
                "OpenDocument Text Template", "R.drawable.mime_odt", "R.drawable.mime_256_odt");
        insert(db, "p65", MimeType.TYPE_APPLICATION, "pagemaker", "Adobe PageMaker", ICON_GENERIC, ICON_GENERIC_LARGE);
        insert(db, "pages", MimeType.TYPE_APPLICATION, "vnd.apple.pages", "Apple iWork Pages", "R.drawable.mime_pages",
                "R.drawable.mime_256_pages");
        insert(db, "pbm", MimeType.TYPE_IMAGE, "x-portable-bitmap", "Portable Bitmap", ICON_IMG, ICON_IMG_LARGE);
        insert(db, "pdf", MimeType.TYPE_APPLICATION, "pdf", "Adobe PDF Document", "R.drawable.mime_pdf",
                "R.drawable.mime_256_pdf");
        ...
        insert(db, "pot", MimeType.TYPE_APPLICATION, "vnd.ms-powerpoint", "Micosoft PowerPoint", "R.drawable.mime_ppt",
                "R.drawable.mime_256_ppt");
        insert(db, "potm", MimeType.TYPE_APPLICATION, "vnd.ms-powerpoint.template.macroenabled.12",
                "Microsoft PowerPoint 2007 macro-enabled presentation template", "R.drawable.mime_ppt",
                "R.drawable.mime_256_ppt");
        insert(db, "potx", MimeType.TYPE_APPLICATION, "vnd.openxmlformats-officedocument.presentationml.template",
                "Microsoft PowerPoint 2007 template", "R.drawable.mime_ppt", "R.drawable.mime_256_ppt");
        insert(db, "ppa", MimeType.TYPE_APPLICATION, "vnd.ms-powerpoint", "Microsoft PowerPoint",
                "R.drawable.mime_ppt", "R.drawable.mime_256_ppt");
        insert(db, "ppam", MimeType.TYPE_APPLICATION, "vnd.ms-powerpoint.addin.macroenabled.12",
                "Microsoft PowerPoint 2007 add-in", "R.drawable.mime_ppt", "R.drawable.mime_256_ppt");
        insert(db, "ppj", MimeType.TYPE_IMAGE, "vnd.adobe.premiere", "Adobe Premiere", "R.drawable.mime_ppj",
                "R.drawable.mime_256_ppj");
        insert(db, "ppm", MimeType.TYPE_IMAGE, "x-portable-pixmap", "Pixmap Image", ICON_IMG, ICON_IMG_LARGE);
        insert(db, "pps", MimeType.TYPE_APPLICATION, "vnd.ms-powerpoint", "Micosoft PowerPoint", "R.drawable.mime_ppt",
                "R.drawable.mime_256_ppt");
        insert(db, "ppsm", MimeType.TYPE_APPLICATION, "vnd.ms-powerpoint.slideshow.macroenabled.12",
                "Microsoft PowerPoint 2007 macro-enabled slide show", "R.drawable.mime_ppt", "R.drawable.mime_256_ppt");
        insert(db, "ppt", MimeType.TYPE_APPLICATION, "vnd.ms-powerpoint", "Microsoft PowerPoint",
                "R.drawable.mime_ppt", "R.drawable.mime_256_ppt");
        insert(db, "pptm", MimeType.TYPE_APPLICATION, "vnd.ms-powerpoint.presentation.macroenabled.12",
                "Microsoft PowerPoint 2007 macro-enabled presentation", "R.drawable.mime_ppt",
                "R.drawable.mime_256_ppt");
        insert(db, "pptx", MimeType.TYPE_APPLICATION, "vnd.openxmlformats-officedocument.presentationml.presentation",
                "Microsoft PowerPoint 2007 Presentation", "R.drawable.mime_ppt", "R.drawable.mime_256_ppt");
        insert(db, "ppsx", MimeType.TYPE_APPLICATION, "vnd.openxmlformats-officedocument.presentationml.slideshow",
                "Microsoft PowerPoint 2007 slide show", "R.drawable.mime_ppt", "R.drawable.mime_256_ppt");
        insert(db, "prf", MimeType.TYPE_APPLICATION, "pics-rules", "PICSRules", ICON_GENERIC, ICON_GENERIC_LARGE);
        insert(db, "prn", MimeType.TYPE_APPLICATION, "remote-printing", "Printer Text File", ICON_GENERIC,
                ICON_GENERIC_LARGE);
        insert(db, "properties", MimeType.TYPE_TEXT, "plain", "Plain Text", ICON_TXT, ICON_TXT_LARGE);
        insert(db, "prproj", MimeType.TYPE_IMAGE, "vnd.adobe.premiere", "Adobe Premiere", "R.drawable.mime_ppj",
                "R.drawable.mime_256_ppj");
        ...
        insert(db, "pub", MimeType.TYPE_APPLICATION, "x-mspublisher", "Microsoft Publisher", ICON_GENERIC,
                ICON_GENERIC_LARGE);
        ...
        insert(db, "scd", MimeType.TYPE_APPLICATION, "x-msschedule", "Microsoft Schedule+", ICON_GENERIC,
                ICON_GENERIC_LARGE);
        insert(db, "sda", MimeType.TYPE_APPLICATION, "vnd.stardivision.draw", "StarDraw 5.x", ICON_GENERIC,
                ICON_GENERIC_LARGE);
        insert(db, "ser", MimeType.TYPE_APPLICATION, "java-serialized-object", "Java Serialized Object", ICON_GENERIC,
                ICON_GENERIC_LARGE);
        insert(db, "scd", MimeType.TYPE_APPLICATION, "x-msschedule", "Microsoft Schedule+", ICON_GENERIC,
                ICON_GENERIC_LARGE);
        insert(db, "sds", MimeType.TYPE_APPLICATION, "vnd.stardivision.chart", "StaChart 5.x", ICON_GENERIC,
                ICON_GENERIC_LARGE);
        insert(db, "sdc", MimeType.TYPE_APPLICATION, "vnd.stardivision.calc", "StarCalc 5.x", ICON_GENERIC,
                ICON_GENERIC_LARGE);
        insert(db, "sdp", MimeType.TYPE_APPLICATION, "vnd.stardivision.impress-packed", "StarImpress Packed 5.x",
                ICON_GENERIC, ICON_GENERIC_LARGE);
        insert(db, "sdd", MimeType.TYPE_APPLICATION, "vnd.stardivision.impress", "StarImpress 5.x", ICON_GENERIC,
                ICON_GENERIC_LARGE);
        insert(db, "sdw", MimeType.TYPE_APPLICATION, "vnd.stardivision.writer", "StarWriter 5.x", ICON_GENERIC,
                ICON_GENERIC_LARGE);
        insert(db, "sgl", MimeType.TYPE_APPLICATION, "vnd.stardivision.writer-global", "StarWriter 5.x global",
                ICON_GENERIC, ICON_GENERIC_LARGE);
        ...
        insert(db, "sldm", MimeType.TYPE_APPLICATION, "vnd.ms-powerpoint.slide.macroenabled.12",
                "Microsoft PowerPoint 2007 macro-enabled slide", "R.drawable.mime_ppt", "R.drawable.mime_256_ppt");
        insert(db, "sldx", MimeType.TYPE_APPLICATION, "vnd.openxmlformats-officedocument.presentationml.slide",
                "Microsoft PowerPoint 2007 slide", "R.drawable.mime_ppt", "R.drawable.mime_256_ppt");
        insert(db, "smf", MimeType.TYPE_APPLICATION, "vnd.stardivision.math", "StarMath 5.x", ICON_GENERIC,
                ICON_GENERIC_LARGE);
        ...
        insert(db, "stc", MimeType.TYPE_APPLICATION, "vnd.sun.xml.calc.template",
                "OpenOffice 1.0/StarOffice6.0 Calc 6.0 Template", ICON_GENERIC, ICON_GENERIC_LARGE);
        insert(db, "sti", MimeType.TYPE_APPLICATION, "vnd.sun.xml.impress.template",
                "OpenOffice 1.0/StarOffice6.0 Impress 6.0 Template", ICON_GENERIC, ICON_GENERIC_LARGE);
        insert(db, "stw", MimeType.TYPE_APPLICATION, "vnd.sun.xml.writer.template",
                "OpenOffice 1.0/StarOffice6.0 Writer 6.0 Template", ICON_GENERIC, ICON_GENERIC_LARGE);
        insert(db, "svg", MimeType.TYPE_IMAGE, "svg+xml", "Scalable Vector Graphics Image", ICON_XML, ICON_XML_LARGE);
        insert(db, "swf", MimeType.TYPE_APPLICATION, "x-shockwave-flash", "Shockwave Flash", "R.drawable.mime_swf",
                "R.drawable.mime_256_swf");
        insert(db, "sxc", MimeType.TYPE_APPLICATION, "vnd.sun.xml.calc", "OpenOffice 1.0/StarOffice6.0 Calc 6.0",
                ICON_GENERIC, ICON_GENERIC_LARGE);
        insert(db, "sxd", MimeType.TYPE_APPLICATION, "vnd.sun.xml.draw", "OpenOffice 1.0/StarOffice6.0 Draw 6.0",
                ICON_GENERIC, ICON_GENERIC_LARGE);
        insert(db, "sxi", MimeType.TYPE_APPLICATION, "vnd.sun.xml.impress", "OpenOffice 1.0/StarOffice6.0 Impress 6.0",
                ICON_GENERIC, ICON_GENERIC_LARGE);
        insert(db, "sxw", MimeType.TYPE_APPLICATION, "vnd.sun.xml.writer", "OpenOffice 1.0/StarOffice6.0 Writer 6.0",
                ICON_GENERIC, ICON_GENERIC_LARGE);
        ...
        insert(db, "wmf", MimeType.TYPE_APPLICATION, "x-msmetafile", "Microsoft Windows Metafile", ICON_GENERIC,
                ICON_GENERIC_LARGE);
        ...
        insert(db, "wps", MimeType.TYPE_APPLICATION, "vnd.ms-works", "Microsoft Works", ICON_GENERIC,
                ICON_GENERIC_LARGE);
        ...
        insert(db, "wsdl", MimeType.TYPE_APPLICATION, "wsdl+xml", "Web Services Description Language", ICON_XML,
                ICON_XML_LARGE);
        ...
        insert(db, "xdp", MimeType.TYPE_APPLICATION, "vnd.adobe.xdp+xml", "Adobe Acrobat XML Data Package", ICON_XML,
                ICON_XML_LARGE);
        insert(db, "xhtml", MimeType.TYPE_APPLICATION, "xhtml+xml", "XHTML", ICON_XML, ICON_XML_LARGE);
        insert(db, "xla", MimeType.TYPE_APPLICATION, "vnd.ms-excel", "Microsoft Excel", "R.drawable.mime_xls",
                "R.drawable.mime_256_xls");
        insert(db, "xlam", MimeType.TYPE_APPLICATION, "vnd.ms-excel.addin.macroenabled.12",
                "Microsoft Excel  2007 add-in", "R.drawable.mime_xls", "R.drawable.mime_256_xls");
        insert(db, "xlc", MimeType.TYPE_APPLICATION, "vnd.ms-excel", "Microsoft Excel", "R.drawable.mime_xls",
                "R.drawable.mime_256_xls");
        insert(db, "xlm", MimeType.TYPE_APPLICATION, "vnd.ms-excel", "Microsoft Excel", "R.drawable.mime_xls",
                "R.drawable.mime_256_xls");
        insert(db, "xls", MimeType.TYPE_APPLICATION, "vnd.ms-excel", "Microsoft Excel", "R.drawable.mime_xls",
                "R.drawable.mime_256_xls");
        insert(db, "xlsb", MimeType.TYPE_APPLICATION, "vnd.ms-excel.sheet.binary.macroenabled.12",
                "Microsoft Excel 2007 binary workbook", "R.drawable.mime_xls", "R.drawable.mime_256_xls");
        insert(db, "xlsm", MimeType.TYPE_APPLICATION, "vnd.ms-excel.sheet.macroenabled.12",
                "Microsoft Excel 2007 macro-enabled workbook", "R.drawable.mime_xls", "R.drawable.mime_256_xls");
        insert(db, "xlsx", MimeType.TYPE_APPLICATION, "vnd.openxmlformats-officedocument.spreadsheetml.sheet",
                "Microsoft Excel 2007", "R.drawable.mime_xls", "R.drawable.mime_256_xls");
        insert(db, "xlt", MimeType.TYPE_APPLICATION, "vnd.ms-excel", "Microsoft Excel", "R.drawable.mime_xls",
                "R.drawable.mime_256_xls");
        insert(db, "xltm", MimeType.TYPE_APPLICATION, "vnd.ms-excel.template.macroenabled.12",
                "Microsoft Excel 2007 macro-enabled workbook template", "R.drawable.mime_xls",
                "R.drawable.mime_256_xls");
        insert(db, "xltx", MimeType.TYPE_APPLICATION, "vnd.openxmlformats-officedocument.spreadsheetml.template",
                "Microsoft Excel template 2007", "R.drawable.mime_xls", "R.drawable.mime_256_xls");
        insert(db, "xlw", MimeType.TYPE_APPLICATION, "vnd.ms-excel", "Microsoft Excel", "R.drawable.mime_xls",
                "R.drawable.mime_256_xls");
