 ...
 */
public interface ApiRuntimeAppDefinitionResource
{
    // /////////////////////////////////////////////////////////////////////////////////////
    // SYNC
    // /////////////////////////////////////////////////////////////////////////////////////
    @GET("/api/enterprise/runtime-app-definitions")
    AppDefinitionsRepresentation getAppDefinitions();

    // /////////////////////////////////////////////////////////////////////////////////////
    // ASYNC
    // /////////////////////////////////////////////////////////////////////////////////////
    @GET("/api/enterprise/runtime-app-definitions")
    void getAppDefinitions(Callback<AppDefinitionsRepresentation> callback);
}
