...
public final class Base64
{
    ...
    public static String encodeObject(java.io.Serializable serializableObject, int options) throws java.io.IOException
    {
        ...
        if (serializableObject == null) { throw new NullPointerException("Cannot serialize a null object."); } // end
                                                                                                               // if:
                                                                                                               // null
    ...
    public static String encodeBytes(byte[] source)
    {
        ...
        // we should not force the task to have to catch it.
        String encoded = null;
        try
        {
    ...
    public static byte[] encodeBytesToBytes(byte[] source, int off, int len, int options) throws java.io.IOException
    {
        ...
        if (off + len > source.length) { throw new IllegalArgumentException(String.format(
                "Cannot have offset of %d and length of %d with array of length %d", off, len, source.length)); } // end
                                                                                                                  // if:
                                                                                                                  // off
                                                                                                                  // <
                                                                                                                  // 0
    ...
    private static int decode4to3(byte[] source, int srcOffset, byte[] destination, int destOffset, int options)
    {
        ...
        if (source == null) { throw new NullPointerException("Source array was null."); } // end
                                                                                          // if
    ...
    public static byte[] decode(byte[] source, int off, int len, int options) throws java.io.IOException
    {
        ...
        if (off < 0 || off + len > source.length) { throw new IllegalArgumentException(String.format(
                "Source array with length %d cannot have offset of %d and process %d bytes.", source.length, off, len)); } // end
                                                                                                                           // if
    ...
    public static byte[] decode(String s, int options) throws java.io.IOException
    {
        ...
        if (s == null) { throw new NullPointerException("Input string was null."); } // end
                                                                                     // if
     ...
     *
     * @param closeable the {@link java.io.Closeable} object
     */
     ...
     * {@link RuntimeException} if the charset 'UTF-8' is not available.
     *
    ...
    public static class InputStream extends java.io.FilterInputStream
    {
        ...
        private int options; // Record options used to createNewTask the stream.
        ...
        public int read() throws java.io.IOException
        {
            ...
            if (position >= 0)
            {
                ...
                if ( /* !encode && */position >= numSigBytes) { return -1; } // end
                                                                             // if:
                                                                             // got
                                                                             // data
            ...
            else
            {
                ...
                if (decodabet[theByte & 0x7f] > WHITE_SPACE_ENC)
                {
                    ...
                    { // Enough to output.
                        ...
                        "Invalid character in Base64 data."); } // end else: not
                                                                // white space
                                                                // either
            } // end else: decoding
        } // end write
