...
{
    RUNNING(RequestConstant.STATE_RUNNING), COMPLETED(RequestConstant.STATE_COMPLETED), ALL(RequestConstant.STATE_ALL);

    private final String value;

    ProcessState(String v)
    {
        value = v;
    }

    public static ProcessState fromValue(String v)
    {
