...
import com.activiti.client.api.ApiAppVersionResource;
...
{
    protected ApiAppVersionResource api;

    InfoService(RestManager manager)
    {
        super(manager);
        api = manager.adapter.create(ApiAppVersionResource.class);
    }

    public void getInfo(Callback<AppVersionRepresentation> callback)
    {
        api.getAppVersion(callback);
    }
